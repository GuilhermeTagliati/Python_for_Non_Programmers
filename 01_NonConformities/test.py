...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.settings_image = self.load_image("./assets/settings.png", 20)
        self.bell_image = self.load_image("./assets/bell.png", 20)
        self.add_folder_image = self.load_image("./assets/add-folder.png", 20)
        self.add_list_image = self.load_image("./assets/add-folder.png", 20)
        self.add_user_image = self.load_image("./assets/add-user.png", 20)
        self.chat_image = self.load_image("./assets/chat.png", 20)
        self.home_image = self.load_image("./assets/home.png", 20)
